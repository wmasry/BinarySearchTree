...
# Author : Wael Bahloul
# This is the BST class with all the functions required,
# The main class is testing all operations (findMin, findMax, 
# ...... etc) and will run the required test as per the 
# assignment as well  
